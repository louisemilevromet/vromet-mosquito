...
define(["require", "exports", "./ObjetVisible"], function (require, exports, ObjetVisible_1) {
    ...
    exports.PointageMoustique = void 0;
    var PointageMoustique = /** @class */ (function (_super) {
        __extends(PointageMoustique, _super);
        function PointageMoustique(refScene, unX, unY, refJeu) {
            ...
            _this.gotoAndPlay(0); // Démarre l'animation du clip
            return _this;
        }
        PointageMoustique.prototype.dessiner = function () {
        ...
        PointageMoustique.prototype.arreterPointageMoustique = function () {
            this.arreterObjetVisible(); // Appelle la méthode parente pour arrêter l'objet visible
        };
        return PointageMoustique;
    }(ObjetVisible_1.ObjetVisible));
    exports.PointageMoustique = PointageMoustique;
});
//# sourceMappingURL=PointageMoustique.js.map